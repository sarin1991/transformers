...
class DualMambaConfig(PretrainedConfig):
    """
    ...
    def __init__(
        ...
        intermediate_size_small=8192,
        hidden_size_large=4096,
        state_size=128,
        num_hidden_layers_large=64,
        num_hidden_layers_small=64,
        num_attention_heads_small=32,
        num_key_value_heads_small=32,
        ...
        **kwargs,
        ...
        self.time_step_rank = math.ceil(self.hidden_size_large / 16) if time_step_rank == "auto" else time_step_rank
