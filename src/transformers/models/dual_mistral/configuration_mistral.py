...
class DualMistralConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        hidden_size_large=4096,
        intermediate_size_small=14336,
        intermediate_size_large=14336,
        ...
        cross_attention_num_key_value_heads=8,
        ...
        **kwargs,
        ...
        self.intermediate_size_large = intermediate_size_large
        ...
        self.cross_attention_num_key_value_heads = cross_attention_num_key_value_heads
        self.num_attention_heads_large = num_attention_heads_large
        self.sliding_window = sliding_window

        # for backward compatibility
        if num_key_value_heads_small is None:
            num_key_value_heads_small = num_attention_heads_small
        if num_key_value_heads_large is None:
            num_key_value_heads_large = num_attention_heads_large

        self.num_key_value_heads_small = num_key_value_heads_small
        self.num_key_value_heads_large = num_key_value_heads_large
