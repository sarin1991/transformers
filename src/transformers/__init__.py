...
try:
    ...
    _import_structure["models.cast"].extend(
        [
            "CastForCausalLM",
            "CastForQuestionAnswering",
            "CastForSequenceClassification",
            "CastForTokenClassification",
            "CastModel",
            "CastPreTrainedModel",
        ]
    )
...
if TYPE_CHECKING:
    ...
    from .models.cast import CastConfig
